...
( function( $ ) {
	...
	wpex = {
		...
		lightboxSingle: function( $context ) {
			...
			var self    = this;
			var targets = '.wpex-lightbox, .wpex-lightbox-video, .wpb_single_image.video-lightbox a, .wpex-lightbox-autodetect, .wpex-lightbox-autodetect a';
			...
			$context.on( 'click', targets, function( event ) {
				...
				var oldOpts        = $this.data( 'options' ) && eval( '({' + $this.data( 'options' ) + '})' ) || '';
		...
		lightboxGallery: function( $context ) {
			...
			$context.on( 'click', 'a.wpex-lightbox-group-item', function( event ) {
				...
				$groupItems.each( function( index ) {
					...
					var oldOpts    = $item.data( 'options' ) && eval( '({' + $item.data( 'options' ) + '})' ) || '';
